  ...
  rows.push(
    <div className="layer-ui__library-header" key="library-header">
      ...
      <a
        ...
        href={`https://libraries.excalidraw.com?target=${window.name || "_blank"}&referrer=${referrer}&useHash=true&token=${id}&theme=${theme}`}
      ...
      <Island padding={2} style={{ zIndex: 1 }}>
        <Stack.Col gap={4}>
          <Stack.Row gap={1} justifyContent="space-between">
            ...
            <Separator />
            {actionManager.renderAction("saveAndClear")}
            <Separator />
